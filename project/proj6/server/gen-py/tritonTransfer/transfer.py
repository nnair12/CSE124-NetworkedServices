...
class Client(Iface):
  ...
  def registerBlockServer(self, port):
    ...
    Parameters:
     - port
    """
    self.send_registerBlockServer(port)
    return self.recv_registerBlockServer()

  def send_registerBlockServer(self, port):
    self._oprot.writeMessageBegin('registerBlockServer', TMessageType.CALL, self._seqid)
    args = registerBlockServer_args()
    args.port = port
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_registerBlockServer(self):
    ...
    if mtype == TMessageType.EXCEPTION:
      ...
      raise x
    result = registerBlockServer_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "registerBlockServer failed: unknown result");
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap = {}
    self._processMap["registerBlockServer"] = Processor.process_registerBlockServer
  ...
  def process_registerBlockServer(self, seqid, iprot, oprot):
    args = registerBlockServer_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = registerBlockServer_result()
    result.success = self._handler.registerBlockServer(args.port)
    oprot.writeMessageBegin("registerBlockServer", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class registerBlockServer_args:
  """
  Attributes:
   - port
  """
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      ...
      return
    oprot.writeStructBegin('registerBlockServer_args')
...
class registerBlockServer_result:
  """
  Attributes:
   - success
  """
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('registerBlockServer_result')
